# This file performs missing link prediction on the synthetic networks across varying rho (the RGG networks are assortative)
...
# net_folder = os.path.join('..','Synth_Nets_Directed_Assortative')
# res_folder = os.path.join('..','Results_Synthetic_Directed_Assortative')
